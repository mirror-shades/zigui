...
export fn main() void {
    ...
    logStr("\n============================= html canvas example =============================");
    {
        ...
        // Simple house shape for testing
        const shapes = [_][]const f64{
            // Roof triangle
            &[_]f64{ 75, 20, 20, 60, 130, 60 },
            // House body (rectangle)
            &[_]f64{ 30, 60, 120, 60, 120, 120, 30, 120, 30, 60 },
            // Door
            &[_]f64{ 60, 90, 60, 120, 90, 120, 90, 90, 60, 90 },
            // Window
            &[_]f64{ 40, 70, 55, 70, 55, 85, 40, 85, 40, 70 },
        };
